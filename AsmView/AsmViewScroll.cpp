...
//
bool AsmView::PinToBottomCorner()
{
	bool repos = false;
...
//
LONG AsmView::OnSize(UINT nFlags, int width, int height)
{
...
//
HRGN AsmView::ScrollRgn(int dx, int dy, bool fReturnUpdateRgn)
{
	RECT clip;
...
//
VOID AsmView::Scroll(int dx, int dy)
{
...
//
LONG AsmView::OnVScroll(UINT nSBCode, UINT nPos)
{
...
//
LONG AsmView::OnHScroll(UINT nSBCode, UINT nPos)
{
...
LONG AsmView::OnMouseWheel(int nDelta)
{
